...
crim = st.number_input("CRIM - per capita crime rate by town (Range: 0 to 100)", value=0.0, key="crim")
zn = st.number_input("ZN - proportion of residential land zoned for lots over 25,000 sq.ft. (Range: 0 to 100)", value=0.0, key="zn")
indus = st.number_input("INDUS - proportion of non-retail business acres per town (Range: 0 to 30)", value=0.0, key="indus")
chas = st.number_input("CHAS - Charles River  variable (0: No, 1: Yes)", value=0.0, key="chas")
nox = st.number_input("NOX - nitric oxides concentration (parts per 10 million) (Range: 0 to 1)", value=0.0, key="nox")
rm = st.number_input("RM - average number of rooms per dwelling (Range: 1 to 15)", value=0.0, key="rm")
age = st.number_input("AGE - proportion of owner-occupied units built prior to 1940 (Range: 0 to 100)", value=0.0, key="age")
dis = st.number_input("DIS - weighted distances to five Boston employment centres  (Range: 0 to 10)", value=0.0, key="dis")
rad = st.number_input("RAD - index of accessibility to radial highways (Range: 0 to 24)", value=0.0, key="rad")
tax = st.number_input("TAX - full-value property-tax rate per $10,000 (Range: 100 to 700)", value=0.0, key="tax")
ptratio = st.number_input("PTRATIO - pupil-teacher ratio by town (Range: 1 to 25)", value=0.0, key="ptratio")
b = st.number_input("B  is the proportion of blacks by town (Range: 0 to 100) ", value=0.0, key="b")
lstat = st.number_input("LSTAT - % lower status of the population (Range: 0 to 40)", value=0.0, key="lstat")
